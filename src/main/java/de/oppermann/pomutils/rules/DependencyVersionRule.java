...
public class DependencyVersionRule extends AbstractRule {

	private final Logger logger = LoggerFactory.getLogger(DependencyVersionRule.class);

	public DependencyVersionRule() {
		// for creating this instance via snakeyaml
	}

	public DependencyVersionRule(SelectionStrategy strategy) {
		super(strategy);
		logger.debug("Using DependencyVersionRule with strategy [{}]", strategy.toString());
	}
